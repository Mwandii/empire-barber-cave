    ...
    return (
        <nav className="flex justify-between items-center text-white relative z-10">
            ...
            <div>
                ...
                <Link to={'/servicecatpage'} className="m-2 p-2 border-b-2 border-transparent hover:border-white transition-all duration-300 font-semibold hover:cursor-pointer">Services</Link>
            </div>
        </nav>
    )
}
