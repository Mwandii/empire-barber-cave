...
function AboutPage() {
  return (
    <div className="bg-white text-gray-800">
      ...
      {/* Headline */}
      <AnimateOnScroll className="text-center py-10" delay={50}>
      ...
      <section className="bg-gray-100 py-16 px-6 md:px-20 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <AnimateOnScroll className="" delay={80}>
          ...
          <AnimateOnScroll className="" delay={160}>
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
              <div className="text-5xl text-gray-800 mb-4 flex justify-center">
                <FaSmile />
              </div>
          ...
          <AnimateOnScroll className="" delay={240}>
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
              <div className="text-5xl text-gray-800 mb-4 flex justify-center">
                <FaClock />
              </div>
          ...
          <AnimateOnScroll className="" delay={320}>
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
              <div className="text-5xl text-gray-800 mb-4 flex justify-center">
                <HiOutlineSparkles />
              </div>
